        ...
        <div style={{ maxWidth: '46rem', padding: '3rem 2rem 7rem', width: '100%' }}>
          ...
          <List
            items={[
              ...
              'The moons are spheres at their mean radius, in flat colour, turned no particular way. Most are really triaxial — Mimas is 208 by 197 by 191 km, its long axis locked toward Saturn — and drawing that shape honestly needs to know which way each one faces. Their rotation, shapes and surface maps come next, checked against JPL together.',
