      ...
      <div style={{ maxWidth: '46rem', padding: '3rem 2rem 4rem', width: '100%' }}>
        ...
        <List
          items={[
            ...
            'Earth’s surface map is drawn 35% less saturated than the file it comes from. The file is an illustrative composite with colour added by its authors, and it is too vivid: measured against NASA’s own render, their open sea sits at 0.37 mean saturation and ours at 0.45. The correction is applied when drawing, never to the image on disk.',
            'Earth has no atmosphere yet, and it is the largest remaining difference from NASA’s render — theirs hazes the whole globe blue, enough that no pixel of their land reads as green. That is a separate piece of work, not a setting.',
